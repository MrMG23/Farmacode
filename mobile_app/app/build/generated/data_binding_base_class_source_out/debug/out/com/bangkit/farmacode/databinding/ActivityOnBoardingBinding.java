...
public final class ActivityOnBoardingBinding implements ViewBinding {
  ...
  private ActivityOnBoardingBinding(@NonNull ConstraintLayout rootView,
      @NonNull ViewPager2 boardingViewPager) {
    this.rootView = rootView;
    this.boardingViewPager = boardingViewPager;
  }
  ...
  public static ActivityOnBoardingBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.boarding_view_pager;
      ViewPager2 boardingViewPager = rootView.findViewById(id);
      if (boardingViewPager == null) {
        break missingId;
      }

      return new ActivityOnBoardingBinding((ConstraintLayout) rootView, boardingViewPager);
    }
